...
public class MainActivity extends AppCompatActivity implements
    ...
    private void refreshPlacesData() {
        ...
        while (cursor.moveToNext() && index < ids.length) {

            String id = cursor.getString(cursor.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID));
            ids[index] = id;
        ...
        PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi.getPlaceById(mClient, ids);
